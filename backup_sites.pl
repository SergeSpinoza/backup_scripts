...
# Archive and move to the folder that was created before, to archive the directory it is necessary to put the key -r
# Sample: system "cp -r /netup/utm5/bin $dir_name";
$archive_dir1 =  `cp -r /var/www $dir_name 2>>$pwd/err.log`;
print "Postfix config copired... \n";
